...
io500_mpirun="mpirun"
io500_mpiargs="-np 1 -x DARSHAN_MODMEM=300 -x DARSHAN_NAMEMEM=300 -x DXT_ENABLE_IO_TRACE=1 -x LD_PRELOAD=/root/darshan_modified/darshan-runtime/lib/.libs/libdarshan.so -x DARSHAN_LOGFILE=$2 --allow-run-as-root"
...
function main {
  ...
  export io500_resultdir=$(get_ini_global_param resultdir $PWD/results)/${ts}_${server_pid_run}
